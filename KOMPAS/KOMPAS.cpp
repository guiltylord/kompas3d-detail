...
// KOMPAS.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CKOMPASApp, CWinApp)
...
// Единственный объект CKOMPASApp

CKOMPASApp theApp;


// Инициализация CKOMPASApp

BOOL CKOMPASApp::InitInstance()
{
